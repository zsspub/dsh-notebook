...
export function NotebookPanel({ t, api, useTabInfo }) {
    ...
    return _jsxs(_Fragment, { children: [_jsx("style", { children: styles }), _jsxs("main", { className: "dsh-notebook", "data-detail": selected !== undefined || draft !== undefined, "data-empty": result.notes.length === 0 && selected === undefined && draft === undefined, children: [_jsxs("section", { className: "dsh-notebook-list-pane", children: [_jsxs("header", { className: "dsh-notebook-list-head", children: [_jsxs("div", { className: "dsh-notebook-scope", children: [_jsx(Menu, { open: scopeMenuOpen, onClose: () => setScopeMenuOpen(false), items: scopeItems, selectedId: scopeId, onSelect: (id) => {
                                                    ...
                                                    setScopeMenuOpen(false);
                                                        ...
                                                        : view === 'recent' ? _jsx(Clock3, { size: 14 }) : _jsx(FileText, { size: 14 }), "aria-label": t('scope'), "aria-haspopup": "menu", "aria-expanded": scopeMenuOpen, onClick: () => setScopeMenuOpen(open => !open), children: [_jsx("span", { className: "dsh-notebook-scope-label", children: scopeLabel }), _jsx(ChevronDown, { size: 13 })] }) }), _jsxs("div", { className: "dsh-notebook-actions", children: [_jsx(Button, { size: "sm", variant: "ghost", icon: _jsx(Plus, { size: 14 }), "aria-label": t('newNotebook'), title: t('newNotebook'), onClick: () => setNotebookForm({ name: '' }) }), activeNotebook && _jsxs(_Fragment, { children: [_jsx(Button, { size: "sm", variant: "ghost", icon: _jsx(Pencil, { size: 13 }), "aria-label": t('rename'), title: t('rename'), onClick: () => setNotebookForm({
                                                                    id: activeNotebook.id, revision: activeNotebook.revision, name: activeNotebook.name,
                                                                }) }), _jsx(Button, { size: "sm", variant: "ghost", icon: _jsx(Trash2, { size: 13 }), "aria-label": t('delete'), title: t('delete'), disabled: activeNotebook.noteCount + activeNotebook.archivedNoteCount > 0, onClick: () => setConfirmation({ kind: 'notebook', id: activeNotebook.id, revision: activeNotebook.revision }) })] })] })] }), _jsxs("div", { className: "dsh-notebook-search-row", children: [_jsxs("div", { className: "dsh-notebook-row", children: [_jsx(Search, { size: 14, "aria-hidden": "true" }), _jsx(Input, { value: query, onChange: event => setQuery(event.currentTarget.value), placeholder: t('search'), "aria-label": t('search') })] }), _jsx(Button, { size: "sm", variant: "primary", icon: _jsx(Plus, { size: 14 }), onClick: () => setDraft(emptyDraft(notebookId || overview?.notebooks[0]?.id)), children: t('newNote') })] }), (overview?.tags.length ?? 0) > 0 && _jsx("div", { className: "dsh-notebook-pills", children: overview?.tags.map(value => _jsxs(Pill, { active: tag === value, onClick: () => setTag(current => current === value ? '' : value), children: [_jsx(TagIcon, { size: 11 }), " ", value] }, value)) })] }), error && _jsxs("div", { className: "dsh-notebook-error", role: "alert", children: [t('error'), ": ", error] }), loading && result.notes.length === 0
                            ...
                            : selected
                                ...
                                : result.notes.length > 0
                                    ? _jsxs("div", { className: "dsh-notebook-empty dsh-notebook-select-hint", children: [_jsx(FileText, { size: 30 }), _jsx("p", { children: t('selectNote') })] })
