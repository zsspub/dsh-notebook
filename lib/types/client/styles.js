...
.dsh-notebook-row,.dsh-notebook-actions,.dsh-notebook-meta,.dsh-notebook-pills,.dsh-notebook-scope,.dsh-notebook-search-row,.dsh-notebook-menu-label{display:flex;align-items:center;gap:8px}
.dsh-notebook-list-pane{display:flex;width:340px;min-width:280px;flex:none;flex-direction:column;border-right:1px solid var(--dsw-alias-border-l2)}
.dsh-notebook-list-head{display:flex;flex-direction:column;gap:12px;padding:16px;border-bottom:1px solid var(--dsw-alias-border-l2)}
.dsh-notebook-scope,.dsh-notebook-search-row{justify-content:space-between}.dsh-notebook-scope-select{max-width:220px}.dsh-notebook-scope-label{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.dsh-notebook-search-row>.dsh-notebook-row{min-width:0;flex:1}.dsh-notebook-search-row>.dsh-notebook-row>div{min-width:0;flex:1}
...
.dsh-notebook-empty h3{color:var(--dsw-alias-label-primary);font-size:15px}.dsh-notebook-empty svg{opacity:.75}.dsh-notebook-select-hint{min-height:0}
...
.dsh-notebook[data-empty=true] .dsh-notebook-list-pane{width:100%;border-right:0}.dsh-notebook[data-empty=true]>.dsh-notebook-detail{display:none}
...
@container(max-width:760px){.dsh-notebook-list-pane{width:100%;min-width:0;border-right:0}.dsh-notebook-detail{display:none}.dsh-notebook[data-detail=true] .dsh-notebook-list-pane{display:none}.dsh-notebook[data-detail=true] .dsh-notebook-detail{display:flex}.dsh-notebook-back{display:inline-flex}}
